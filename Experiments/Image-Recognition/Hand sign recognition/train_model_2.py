...
"""
In this V2 i use the RPSmodelV2 that have dropout layers,
and i use adam optimizer instead of SGD.
in addition i run on device (GPU) 
"""
...
model = RPSModelV2(input_features=NUM_FEATURES, output_features=NUM_CLASSES).to(device)
print("MODEL:\n", model)
